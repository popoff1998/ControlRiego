 ...
 * -------------------------------------------------------------------------------------- */
    ...
    static unsigned long lastmillisReconnect = 0; // contador para verificar cada RECONNECTINTERVAL minutos
    static unsigned long lastmillisLargo    = 0; // contador para verificar cada LONGINTERVAL minutos
    timeval tv;
...
void setLedsRiego(velocidad_parpadeo ledblink = NULO);
